...
function NovelItem({post,key}) {
    return (
        <div  key={key}>
            <div className="my-1 place-items-center   flex  sm:pl-2  rounded-xl  sm:w-full ">
             <Link to={`/novel/${post.slug}`}>
               <div className="relative ">
             <img className="2xl:h-60  2xl:w-52 xl:h-52 xl:w-44  h-40  w-32 lg:h-44 lg:w-40 sm:h-44 sm:w-36 " src={post.cover}  alt="" />

    ...
    return (
        <div  key={key}>
            <div className="my-1 place-items-center flex sm:pl-4  rounded-xl  sm:w-full ">
             ...
             <img className="2xl:h-64  2xl:w-48 xl:h-56 xl:w-40  h-40  w-32 lg:h-48 lg:w-36 sm:h-48 sm:w-40 " src={post.cover}  alt="" />
             ...
             <h1 className="sm:w-32 w-32 min-w-28 truncate text-xs sm:text-sm 
